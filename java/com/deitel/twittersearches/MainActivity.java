...
public class MainActivity extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      deleteAll.setOnClickListener(deleteListener);
   }
   ...
   private void deleteAllTags(){
      ...
      deleteBuilder.setMessage("Are you sure that you want to delete all tags?");

      deleteBuilder.setNegativeButton("Cancel", null);

      deleteBuilder.setPositiveButton("Delete",
              new DialogInterface.OnClickListener() {
                 @Override
                 public void onClick(DialogInterface dialog, int which) {
                    tags.removeAll(tags);
